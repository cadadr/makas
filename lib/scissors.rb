...
module Scissors
  ...
  def self.collect_pages path, recursive: true
  ...
  # modified.
  def self.drop_up_to_date mappings
    hash = {}
  ...
  def self.apply_templates pages, templates
    hash = {}
  ...
  # files.
  def self.write_pages pages, mappings
  ...
  def self.copy_static_files static_root, target_root
  ...
  def self.copy_feeds sources_root, target_root
  ...
  # pathnames.
  def self.collect_blog_posts blog_opts
  ...
  def self.write_blog blog, target_file, template
  ...
  def self.generate_blog_page blog_opts, templates
  ...
  def self.build_site site_opts, force_regeneration: false, verbose: false
    ...
    ret[:pages] = generate_pages sources_root, output_directory, templates, force_regeneration
